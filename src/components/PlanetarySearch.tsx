...
import { Globe, Search, Loader2, Calendar, MapPin, Image, Minimize2, Maximize2, Mountain, Leaf, Thermometer, TreePine } from "lucide-react";
...
const COLLECTIONS = {
  'sentinel-1-grd': { name: 'Sentinel-1 SAR', icon: Globe, color: 'text-radar' },
  ...
  'modis-17A3HGF-061': { name: 'MODIS Biomassa', icon: TreePine, color: 'text-vegetation' },
  ...
  'hgb': { name: 'Biomassa Global', icon: TreePine, color: 'text-vegetation' },
  'esa-worldcover': { name: 'ESA WorldCover', icon: Globe, color: 'text-optical' },
